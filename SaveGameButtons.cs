...
public class SaveGameButtons : MonoBehaviour {
		
// ---------------------------------------- START: LIST OF VARIABLES ----------------------------------------
// --------------- PUBLIC VARIABLES ---------------
	public Button UISaveGameSaveButton;
...
// --------------- START FUNCTION ---------------
	void Start() {
        ...
        // Save Button
		Button UISaveGameSaveButtonClick = UISaveGameSaveButton.GetComponent<Button>();
		UISaveGameSaveButtonClick.onClick.AddListener(UISaveGameSaveButtonClicking);
	}
...
// --------------- BUTTON FUNCTIONS ---------------
    public void UISaveGameSaveButtonClicking() {
        WriteGhostTimerData();
